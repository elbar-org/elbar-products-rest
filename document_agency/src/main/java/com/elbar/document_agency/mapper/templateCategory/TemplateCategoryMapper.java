...
public interface TemplateCategoryMapper extends GenericMapper<TemplateCategoryCreateDTO, TemplateCategoryUpdateDTO, TemplateCategoryGetDTO, GenericDTO, TemplateCategoryEntity> {
}
