...
public interface WorkspaceImageMapper extends GenericMapper<WorkspaceImageCreateDTO, WorkspaceImageUpdateDTO, WorkspaceImageGetDTO, GenericDTO, WorkspaceImage> {
}
