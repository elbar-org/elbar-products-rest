...
public interface WorkspaceCommentMapper extends GenericMapper<WorkspaceCommentCreateDTO, GenericDTO, WorkspaceCommentGetDTO, WorkspaceCommentDetailDTO, WorkspaceCommentEntity> {
}
