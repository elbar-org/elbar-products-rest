...
public interface WorkspaceMemberMapper extends GenericMapper<WorkspaceMemberCreateDTO, WorkspaceMemberUpdateDTO, WorkspaceMemberGetDTO, GenericDTO, WorkspaceMember> {
}
