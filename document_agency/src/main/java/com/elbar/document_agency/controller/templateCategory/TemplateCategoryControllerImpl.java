...
public class TemplateCategoryControllerImpl extends AbstractController<TemplateCategoryServiceImpl> implements TemplateCategoryController {

    public TemplateCategoryControllerImpl(TemplateCategoryServiceImpl service) {
        super(service);
    }
